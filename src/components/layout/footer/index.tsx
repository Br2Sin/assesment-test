  ...
  return (
    <footer className="flex flex-col pt-8 pb-4 px-4 relative gap-6 z-0">
      <div className="flex justify-center sm:justify-end px-2 sm:px-8">
        ...
        <div className="z-0 absolute right-0 aspect-w-square bg-app-black-light rounded-full w-96 h-96 top-0 transform -translate-y-full"></div>
        <div className="flex gap-2 sm:gap-6 justify-around w-full sm:w-max xs:flex-row flex-col">
          <LinkButton icon="/assets/icon/ico_discord.svg" name="Join Discord" />
          <LinkButton icon="/assets/icon/ico_twitter.svg" name="Join Twitter" />
        </div>
      </div>
